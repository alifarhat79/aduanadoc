...
def test_trailing_ean_codes_separation():
    ...
    casos = [
        ...
        ("I0095135 ARMAF ODYSSEY TYRANT (M)EDP SP 3.4OZ 6294015160734", "ARMAF", "6294015160734", "ARMAF ODYSSEY TYRANT (M)EDP SP 3.4OZ"),
        ...
        # Casos reales de despachos SOFIA con prefijos arancelarios burocráticos
        ("LOS DEMAS EN 2.680 UNIDADES ASDAAF AMEERAT AL ARAB PRIVE ROSE 100ML", "ASDAAF", "", "ASDAAF AMEERAT AL ARAB PRIVE ROSE 100ML"),
        ("LOS DEMAS EN 3.486 UNIDADES MAISON ALHAMBRA SALVO INTENSE 100ML", "MAISON ALHAMBRA", "", "MAISON ALHAMBRA SALVO INTENSE 100ML"),
        ("LOS DEMAS EN 2.385 UNIDADES MAISON ALHAMBRA ALPINE HOMME SPORT 100ML", "MAISON ALHAMBRA", "", "MAISON ALHAMBRA ALPINE HOMME SPORT 100ML"),
        ("LOS DEMAS EN 2589 UNIDADES MAISON ALHAMBRA ROSE SEDUCTION VIP FOUR FEMME 100ML", "MAISON ALHAMBRA", "", "MAISON ALHAMBRA ROSE SEDUCTION VIP FOUR FEMME 100ML"),
        ("LOS DEMAS EN 7.000 UNIDADES YARA 200ML SPRAY CORPORAL", "LATTAFA", "", "YARA 200ML SPRAY CORPORAL"),
        ("LOS DEMAS EN: 7.000 UNIDADES KHAMRAH 200ML SPRAY CORPORAL", "LATTAFA", "", "KHAMRAH 200ML SPRAY CORPORAL"),
        ("LOS DEMÁS EN 500 KILOS HARINA DE TRIGO ESPECIAL", "", "", "HARINA DE TRIGO ESPECIAL"),
        ("LOS DEMAS - ARTICULOS DE TOCADOR", "", "", "ARTICULOS DE TOCADOR"),
        ("UNIDADES DE RED ACNE BODY WASH 2.0 ITEM: PMEKR55005R04", "MEDICUBE", "", "RED ACNE BODY WASH 2.0 ITEM: PMEKR55005R04"),
        ("245 UNIDADES HASS ECO B1 ELECTRIC BIKE MOTOR:500W", "HASS", "", "HASS ECO B1 ELECTRIC BIKE MOTOR:500W"),
        ("2.016-UNIDADES RASASI HAWAS BLACK 100ML (331033)", "RASASI", "", "RASASI HAWAS BLACK 100ML (331033)")
    ]
